...
public class RequestProvider : IRequestProvider
{
    ...
    public async Task<TResult> PostAsync<TResult, TRequest>(string uri, TRequest data, string token = "", string header = "")
    {
        HttpClient httpClient = GetOrCreateHttpClient(token);
    ...
    public async Task<TResult> PutAsync<TResult, TRequest>(string uri, TRequest data, string token = "", string header = "")
    {
        HttpClient httpClient = GetOrCreateHttpClient(token);
